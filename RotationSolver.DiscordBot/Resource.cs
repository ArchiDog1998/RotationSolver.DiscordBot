...
{
    public const string DefaultDuty = "Everkeep (Extreme)";
    ...
    [
        ...
        ("Worqor Zormor", 112555, 1, 1, 2),
        ("Origenics", 112558, 1, 1, 2),
        ("Ihuykatumu", 112554, 1, 1, 2),
        ("Alexandria", 112559, 1, 1, 2),
        ("The Skydeep Cenote", 112556, 1, 1, 2),
        ("the Porta Decumana", 112468, 1, 1, 2),
        ("Vanguard", 112557, 1, 1, 2),
        ("Worqor Lar Dor", 112562, 2, 2, 4),
        ("Worqor Lar Dor (Extreme)", 112563, 2, 2, 4),
        ("Tender Valley", 112560, 1, 1, 2),
        ...
        ("AAC Light-heavyweight M1 (Savage)", 112568, 2, 2, 4),
        ("AAC Light-heavyweight M2", 112569, 2, 2, 4),
        ("AAC Light-heavyweight M2 (Savage)", 112570, 2, 2, 4),
        ("AAC Light-heavyweight M3", 112571, 2, 2, 4),
        ("AAC Light-heavyweight M3 (Savage)", 112572, 2, 2, 4),
        ("AAC Light-heavyweight M4", 112573, 2, 2, 4),
        ("AAC Light-heavyweight M4 (Savage)", 112574, 2, 2, 4),
